<template>
  <nav>
    <div class="max-lg:hidden m-4 ml-8 mr-8 ">
      <div class="">
        <input class="hidden" type="checkbox" />
        <label class="menu__btn" for="menu__toggle"></label>

        <ul class="flex flex-row content-center font-sans pl-[2%] pr-[2%] whitespace-nowrap text-xl border-b-[solid] border-b-[#474747]">
          ...
          <li class="ml-[6%] text-[black] mr-[6%]">
            <a href="#" class="text-[#271819]"><input type="text"
                class=" absolute w-[8%] h-10 font-sans  text-gray-600 text-[20px] pr-[35px] px-3 py-2.5 pb-3 rounded-[100px]  border-[2px] border-gray-400 top-[32px]"
                placeholder="Search" />
              <svg class="absolute ml-[5%]  h-[15px]   top-[46px]" stroke="currentColor" fill="black"
    ...
    <div class="lg:hidden">
      <button type="button"
        ...
        <svg class="h-8 w-8 text-black mt-2" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
          stroke-linecap="round" stroke-linejoin="round" v-on:click="isShow = !isShow">
          <line x1="3" y1="12" x2="21" y2="12" />
          <line x1="3" y1="6" x2="21" y2="6" />
          <line x1="3" y1="18" x2="21" y2="18" />
        </svg>
        <aside v-show="isShow" class="fixed top-0 left-0 shadow-2xl z-40 w-60 h-full">
        ...
        <div class="fixed font-[bold] font-sans text-black text-[35px] ml-10 mx-[29%] my-0 font-bold">
        ...
        <li class="fixed ml-[78%] sm:ml-[86%] md:ml-[90%] list-none -mt-16">
          <a href="#">
            <input type="text"
              ...
              placeholder="Search" />
            <svg class="absolute w-[60px] h-[15px] right-[-65px] top-[29px]" stroke="currentColor" fill="grey"
              stroke-width="0" viewBox="0 0 512 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
              <path
                d="M505 442.7L405.3 343c-4.5-4.5-10.6-7-17-7H372c27.6-35.3 44-79.7 44-128C416 93.1 322.9 0 208 0S0 93.1 0 208s93.1 208 208 208c48.3 0 92.7-16.4 128-44v16.3c0 6.4 2.5 12.5 7 17l99.7 99.7c9.4 9.4 24.6 9.4 33.9 0l28.3-28.3c9.4-9.4 9.4-24.6.1-34zM208 336c-70.7 0-128-57.2-128-128 0-70.7 57.2-128 128-128 70.7 0 128 57.2 128 128 0 70.7-57.2 128-128 128z">
              </path>
