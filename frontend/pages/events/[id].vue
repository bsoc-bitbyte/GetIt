...
<p class="mb-6 max-w-md text-tertiary-ligh text-[#635e5f]">
    ...
    <div class="space-y-4 md:flex md:items-center md:gap-16 md:space-y-0 flex gap-16">
      <div class="flex justify-center w-1/4 lg:w-1/2 h-[4vh] mt-5 lg:mt-0">
            <button :disabled="qty===0" :class="{ 'opacity-50': qty === 0 }" @click="decrease" class="flex items-center justify-center rounded-l-md px-4 bg-gray-100 transition text-[#fa4750] hover:bg-[#EA454C]  hover:text-white">-</button>
    ...
    <div class="dropdown">
      ...
      <div v-if="showContact" class="dropdown-content text-[#635e5f] px-5" style="max-height: 200px; overflow-y: auto;">
