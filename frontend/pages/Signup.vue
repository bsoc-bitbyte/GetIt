          ...
          <div class="credentials">
            <div class="flex flex-wrap">
              <div class="username py-[0.5rem] w-full md:w-1/2 md:pr-2">
                ...
                <input
                  type="text"
                  class="px-[1rem] border-2 h-[2.69rem] border-black-300 w-full items-center rounded-lg"
                  v-model.trim.lazy="credentials.first_name"
                  placeholder="John"
                  required
                />
              </div>
              <div class="username py-[0.5rem] w-full md:w-1/2 md:pl-2">
                ...
                <input
                  type="text"
                  class="px-[1rem] border-2 h-[2.69rem] border-black-300 w-full items-center rounded-lg"
                  v-model.trim.lazy="credentials.last_name"
                  placeholder="Doe"
                  required
                />
              </div>
