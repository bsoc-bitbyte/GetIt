<template>
  <div class="max-md:-mt-5 max-lg:-mt-8">
    
    <div class=" lg:m-8 mb-20 md:m-5 md:mt-8 m-3 mt-5  z-10">
      <h1 class="text-2xl m-auto font-medium sm:visible max-sm:my-4 md:invisible max-lg:pt-20">{{ product[main].title }}
      </h1>
        ...
        <div class="flex flex-col w-full justify-between md:flex-row">
          <div class="flex flex-col h-3/2 md:w-2/5 gap-6 md:mb-0 mb-8">
            ...
            <div class="mx-auto flex sm:hidden mb-4">
              <div class="w-6 h-6 ring-4 ring-white lg:h-3.5 m-3 bg-black rounded-full"></div>
              <div class="w-6 h-6 ring-4 ring-gray-300 m-3 bg-blue-300 rounded-full"></div>
              <div class="w-6 h-6 ring-4 ring-white m-3 bg-green-300 rounded-full"></div>
              <div class="w-6 h-6 ring-4 ring-white m-3 bg-red-300 rounded-full"></div>
            </div>

            <div class="flex flex-row items-center justify-between gap-2">
              <img class="w-4 h-4 mr-2 my-auto"
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQuwFYGl859TlHkUrVFmrAvNWAOtPby6ZgWMg&usqp=CAU"
                @click="i > 0 ? i-- : (i = 11)" />
              <img class="w-2/12 h-2/6 md:w-1/5 md:h-4/6 aspect-square object-contain rounded-md"
                :src="product[i].image" />
              <img class="w-2/12 h-2/6 md:w-1/5 md:h-4/6 aspect-square object-contain rounded-md"
              ...
              <img class="w-4 h-4 ml-2 transform rotate-180 my-auto"
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQuwFYGl859TlHkUrVFmrAvNWAOtPby6ZgWMg&usqp=CAU"
                @click="i < 12 ? i++ : (i = 0)" />
            </div>
          </div>
          ...
          <div class="mt-8 md:mt-0 lg:mt-16 flex flex-col md:mt-7 md:w-1/2">
            ...
            <div>
              <div
                ...
                <input type="radio" name="Size" value="small" class="peer/small" id="small" checked /><label for="small"
                  class="peer-checked">
              ...
              <div
                class="rounded-full float-left bg-gray-100 text-gray-500 py-1 px-2 font-medium text-xs lg:text-sm flex flex-row lg:mr-4 md:mr-2 m-1">
                <input type="radio" name="Size" value="extra" class="peer/extra" id="extra" /><label for="extra"
                  class="peer-checked">
            ...
            <div
              class=" bg-white shadow-[0px_40px_70px_4px_rgba(0,0,0,0.56)] md:shadow-none md:border-0 m-0 justify-center md:justify-start w-full fixed bottom-0 mx-0 mb-0 flex flex-row md:justify-left sm:mb-0 md:relative gap-0s">
              <button
                class="  gap-0 md:mr-[15%] md:px-[7%] pl-[44%] mr-0  md:ml-0 text-center pr-0 md:py-0 min-w-[88%]  md:min-w-0 bg-white rounded-none font-black flex-none flex items-center  md:rounded-full md:bg-[#EA454C] flex flex-row md:py-2 md:px-3 md:font-normal">
                <img class=" visible md:invisible w-4 h-3 mr-0  filter px-0" src="../../assets/cart01.png">
                <img class=" invisible md:visible w-5 h-5 mr-0 md:mr-1 md:-ml-[15px] filter"
                  src="../../assets/cart02.png">
                <p
                  class="flex-none text-[12px] md:text-[15px] text-center text-black md:text-white sm:text-xs pl-0 md:pl-0 ">
                  Add To Cart</p>
              </button><button
                class="pl-[15%] md:px-[7%] md:py-4 ml-0 py-3 md:py-0 min-w-[92%] text-center md:min-w-0 bg-[#EA454C] font-bold flex-none items-center rounded-none  rounded-full md:bg-[#EA454C] flex flex-row md:rounded-full md:font-normal py-1 sm:ml-3 md:mr-[0%]">
      ...
      <div>
        ...
        <p class="lg:mt-3.5 md:mt-2"><b class="lg:text-2xl md:text-xl font-medium text-gray-700 mt-6 lg:mb-3 flex">Product
            Details</b><b class="font-medium md:text-xs lg:text-sm text-gray-400"> {{ product[main].category }}</b></p>
      </div>
    </div>
  </div>
</template>
