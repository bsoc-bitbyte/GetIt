<template>
  <div class="lg:m-8 mb-20 md:m-5 md:mt-8 m-3 mt-5">
    ...
    <div class="md:flex flex-row mb-5">
      <div class="md:flex md:flex-col flex flex-row md:mt-24 lg:mt-36">
        <div
      ...
      <div class="flex flex-col md:w-1/2">
        <img
          class="ml-6 w-9/12 float-left rounded-xl mr-15"
          :src="product[main].image"
        />
        <div class="flex flex-row mt-6 mb-10 md:w-11/12 ml-4">
          <img
            class="w-4 h-4 mr-2 lg:mt-12 md:mt-7 mt-8"
          ...
          <img
            class="w-4 h-4 ml-2 lg:mt-12 md:mt-7 transform rotate-180 mt-8"
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQuwFYGl859TlHkUrVFmrAvNWAOtPby6ZgWMg&usqp=CAU"
            @click="i < 12 ? i++ : (i = 0)"
          />
        </div>
      </div>
      <div class="lg:mt-14 flex flex-col md:mt-4 md:w-/2">
        <div class="flex flex-row">
          <h1
            class="lg:text-3xl lg:mr-20 md:font-medium lg:font-medium md:text-xl mr-10"
          >
            {{ product[main].title }}
          </h1>
          <img
        ...
        <p class="text-sm lg:text-md font-medium text-gray-400 mt-1 mb-2">
          TPC
        </p>
        ...
        <p class="lg:mt-12 lg:text-4xl font-medium mt-4 text-2xl">
          <b></b> ${{ product[main].price }}
        </p>
        <p
          class="lg:mt-7 text-sm lg:text-lg text-gray-400 font-medium lg:mb-6 pb-.5 mt-4 mb-2"
        >
          Choose a Size
        </p>
        <div class="">
        ...
        <hr class="h-px lg:my-10 my-5 bg-gray-300 border-0 dark:bg-gray-700" />
        <div class="flex flex-row lg:mt-7 mt-1 sm:mb-5 content-center">
          <button
            class="ml-3 rounded-full bg-rose-600 flex flex-row py-2 lg:px-14 lg:py-4 lg:mr-5 px-6 mr-8 max-sm:ml-4"
          >
            <img
              class="w-4 h-4 mr-1 filter invert"
              src="https://cdn-icons-png.flaticon.com/512/711/711895.png"
            />
            <p class="text-xs lg:text-sm text-white lg:-mt-1">Add To Cart</p>
          </button>
          <button
            class="lg:ml-9 md:ml-5 rounded-full bg-rose-600 flex flex-row py-2 lg:px-16 lg:py-4 px-8 sm:ml-3"
          >
            <img
              class="w-4 h-4 mr-1 filter invert"
              src="https://icon-library.com/images/current-icon/current-icon-1.jpg"
            />
            <p class="text-xs lg:text-sm text-white lg:-mt-1">Buy Now</p>
          </button>
        </div>
      </div>
    </div>
