<template>
  <div class="poppins-paragraph lg:m-8 mb-20 md:m-5 md:mt-8 m-3 mt-5">
      <h1 class="text-2xl font-medium sm:visible max-sm:my-4 md:invisible md:font-poppins">{{ product[main].title }}</h1>
      <div class="md:flex flex-row mb-5">
        <div class="md:flex md:flex-col md:mt-24">
          <div
  @click="selectColor('black')"
  :class="['lg:w-3.5 lg:m-2.5 lg:mt-20 lg:h-3.5 md:w-2.5 md:h-2.5 bg-black md:m-1.5 h-3.5 w-3.5 m-3 rounded-full', { 'ring-4 ring-gray-300': selectedColor === 'black' }]"
></div>
<div
  @click="selectColor('blue')"
  :class="['lg:w-3.5 lg:m-2.5 lg:h-3.5 md:w-2.5 md:h-2.5 md:m-1.5 bg-[#ABC6D6] h-3.5 w-3.5 m-3 rounded-full', { 'ring-4 ring-gray-300': selectedColor === 'blue' }]"
></div>
<div
  @click="selectColor('green')"
  :class="['lg:w-3.5 lg:m-2.5 lg:h-3.5 ring-grey md:w-2.5 md:h-2.5 md:m-1.5 bg-[#58D7C4] h-3.5 w-3.5 m-3 rounded-full', { 'ring-4 ring-gray-300': selectedColor === 'green' }]"
></div>
<div
  @click="selectColor('red')"
  :class="['lg:w-3.5 lg:m-2.5 lg:h-3.5 ring-grey md:w-2.5 md:h-2.5 md:m-1.5 bg-[#F2CEC6] h-3.5 w-3.5 m-3 rounded-full', { 'ring-4 ring-gray-300': selectedColor === 'red' }]"
></div>
          ...
          <div class="mt-8 md:mt-0 lg:mt-16 flex flex-col md:mt-7 md:w-1/2">
              ...
              <hr class="h-px bg-[#8D8383] border-0">



              <p class="lg:mt-7 lg:text-3xl font-medium mt-4 text-2xl text-[#271819]"><b></b> ${{ product[main].price }}</p>
        ...
        <hr class="invisible md:visible md:h-px md:lg:my-8 md:my-5 md:bg-[#8D8383] md:border-0 md:dark:bg-[#8D8383]">
              ...
              <div class="md:flex bg-white shadow-[0px_40px_70px_4px_rgba(0,0,0,0.56)] md:shadow-none md:border-0 m-0 justify-center md:justify-start w-full fixed bottom-0 mx-0 mb-0 flex flex-row md:justify-left sm:mb-0 md:relative gap-0s">
                <button class="  gap-0 md:mr-[7%] md:px-[12%] pl-[44%] mr-0  text-center pr-0 md:py-0 min-w-[88%]  md:min-w-0 bg-white rounded-none font-black flex-none flex items-center md:rounded-full md:bg-[#EA454C] flex flex-row md:py-2 md:px-3 md:font-normal">
                    ...
                    <p class="flex-none text-[12px] md:text-[14px] text-center text-black md:text-white sm:text-xs pl-0 md:pl-0 ">Add To Cart</p>
                    ...
                    <p class=" poppins-paragraph text-[12px] md:text-[14px] pr-2 pl-2 text-white sm:text-xs font-poppins">Buy Now</p>
    ...
    <hr class="h-0.5 mt-12 bg-[#8D8383] border-0 dark:bg-[#8D8383]">

  <div>

      <p class="lg:mt-3.5 mt-2 "><b class="lg:text-2xl md:text-xl font-medium lg:mb-3 flex text-[#271819]">Product Description</b><b
              class="font-medium md:text-xs lg:text-sm text-[#667085]">{{ product[main].description }}</b> </p>
      <p class="lg:mt-3.5 md:mt-2"><b
              class="lg:text-2xl md:text-xl font-medium text-[#344054] mt-6 lg:mb-3 flex">Product Details</b><b
