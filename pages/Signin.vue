    ...
    <div class="left-panel">
     ...
     <div class="credentials">
      <div class="email py-[1rem]">
          ...
          <input type="email" class = "border-2 h-[2.69rem] border-black-300 w-full md:w-[25rem] rounded-lg" name="" placeholder="Enter your email"/>
        </div>
        <div class="password  py-[1rem]">
          ...
          <input type="password"  class = "border-2 h-[2.69rem] border-black-300 w-full md:w-[25rem] rounded-lg" name="" placeholder="***********"/>
        </div>
     </div>
        ...
        <div class="sign-in  py-[1rem]">
          <a href="#">
            <button type="submit" id="Sign-up" class = "w-full bg-red-500 h-[3.25rem] rounded-[1.25rem]">
              <p class = "hover:text-white hover:border-slate-500">Sign in</p>
            </button>
          </a>
        </div>
        ...
        <div class="optional-sign-in mt-[0.7rem]">
          <p class = "flex justify-center">
            ...
            <a href="#" class="text-red-500 hover:underlined tracking-wide">Sign up for free</a>
          </p>
        </div>
      </div>
    </div>
