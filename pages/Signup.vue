<template>
  <div class="max-lg:-mt-6">
    ...
    <div
      class="main  min-[1120px]:flex bg-white min-[1120px]:justify-evenly min-[1024px]:py-[0rem] py-[2rem] px-[0.1rem] mt-[1.5rem] max-[1119px]:pb-[2rem]">
      <div class="left-panel mt-[5.5rem] max-[1119px]:hidden min-[1120px]:block">
        <img src="../assets/37.order-delivered-3.png"
          class="w-[34rem] h-[32rem] border-1 border-gray-400 min-[1120px]:order-1" alt="delivery-img">
      </div>
      <div class="right-panel max-[1119px]:px-[2rem] min-[1120px]:px-[0rem]">
        <form @submit="submitForm" class="credentials">
          <div class="credentials - container min-[1120px]:order-2 ">
            <div class="catch-line-outer">
              <div class="catch-line-inner">
                <p class="text-gray-500 font-semibold py-[2rem] max-[1023px]:mt-6">"Gear Up, Sign Up, Shop Now!"</p>
              </div>
            </div>
            <div class="credentials">
              <div class="username py-[0.5rem]">
                ...
                <input type="text"
                  ...
                  v-model.trim.lazy="credentials.username" placeholder="Username" required />
              </div>
              <div class="email py-[0.5rem]">
                ...
                <input type="email"
                  ...
                  v-model.trim.lazy="credentials.email" placeholder="Enter your email" required />
              </div>
              <div class="password  py-[0.5rem]">
                <p class="font-bold text-slate-500/[.98] tracking-wider py-[0.1rem] text-slate-800">Password</p>
                <input type="password"
                  class="px-[1rem] border-2 h-[2.69rem] border-black-300 w-full items-center rounded-lg min-[1120px]:w-[35rem]"
                  v-model.trim.lazy="credentials.password" placeholder="***********" required />
              </div>
              <div class="confirm-password  py-[0.5rem]">
                ...
                <input type="password"
                  class="px-[1rem] border-2 h-[2.69rem] border-black-300 w-full items-center rounded-lg min-[1120px]:w-[35rem]"
                  v-model.trim.lazy="credentials.password_check" placeholder="***********" required @input="checker" />
            ...
            <div class="sign-up  pt-[1rem] pb-[0rem]">
              <a href="#">
                <button type="submit" id="Sign-up"
                  class="signup w-full h-[3.25rem] rounded-[1.25rem] backdrop-blur-lg z-10">
                  <p class="text-white hover:border-slate-500 py-[0rem]">Sign Up</p>
                </button>
              </a>
            </div>
